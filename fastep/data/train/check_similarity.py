...
for d in dirs:
    # Try to read Parquet first, fallback to CSV
    parquet_path = os.path.join(d, "observations.parquet")
    csv_path = os.path.join(d, "observations.csv")
    ...
    if os.path.exists(parquet_path):
        ...
        print(f"Warning: No data file found for {d}")
        continue
