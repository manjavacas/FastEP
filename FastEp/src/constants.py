# STATE_VARIABLES = ['month', 'day_of_month', 'hour', 'outdoor_temperature', 'outdoor_humidity', 'wind_speed', 'wind_direction',
#                    'diffuse_solar_radiation', 'direct_solar_radiation', 'htg_setpoint_living', 'htg_setpoint_kitchen', 'htg_setpoint_bed1', 'htg_setpoint_bed2', 'htg_setpoint_bed3', 'air_temperature_living', 'air_temperature_kitchen', 'air_temperature_bed1', 'air_temperature_bed2', 'air_temperature_bed3', 'air_humidity_living', 'air_humidity_kitchen', 'air_humidity_bed1', 'air_humidity_bed2',
#                    'air_humidity_bed3', 'radiant_hvac_outlet_temperature_living', 'radiant_hvac_outlet_temperature_kitchen', 'radiant_hvac_outlet_temperature_bed1', 'radiant_hvac_outlet_temperature_bed2', 'radiant_hvac_outlet_temperature_bed3', 'heat_source_electricity_rate', 'heat_source_load_side_outlet_temp', 'heat_source_load_side_inlet_temp', 'heat_source_load_side_heat_transfer_rate', 'heat_source_load_side_mass_flow_rate', 'crf', 'heat_cap_mod', 'cop_plr_mod', 'cop_temp_mod', 'plr_current']
